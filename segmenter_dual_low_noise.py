...
if __name__ == "__main__":
    ...
    c_np = np.load("Recons/type_d_dual_recon_low_noise.npy")
    ...
    c_np2 = np.load("Recons/other_dual_recon_low_noise.npy")
    ...
    for e in range(nepochs):
        ...
        if e > 0 and e%n_checkpoint == 0:
            ...
            torch.save(tnet.state_dict(), "Tumor_Segmenters/dual_net_low_noise.pth")
    torch.save(tnet.state_dict(), "Tumor_Segmenters/dual_net_low_noise.pth")
